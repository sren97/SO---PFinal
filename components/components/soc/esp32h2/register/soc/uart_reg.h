...
/** UART_CLKDIV_SYNC_REG(i) register
...
/** UART_CONF0_SYNC_REG(i) register
 *  a
 */
...
/** UART_HWFC_CONF_SYNC_REG(i) register
...
/** UART_SLEEP_CONF0_REG(i) register
...
/** UART_SLEEP_CONF1_REG(i) register
...
/** UART_SLEEP_CONF2_REG(i) register
...
/** UART_SWFC_CONF0_SYNC_REG(i) register
...
/** UART_SWFC_CONF1_REG(i) register
 *  Software flow-control character configuration
 */
...
/** UART_TXBRK_CONF_SYNC_REG(i) register
...
/** UART_IDLE_CONF_SYNC_REG(i) register
...
/** UART_RS485_CONF_SYNC_REG(i) register
...
/** UART_AT_CMD_PRECNT_SYNC_REG(i) register
...
/** UART_AT_CMD_POSTCNT_SYNC_REG(i) register
...
/** UART_AT_CMD_GAPTOUT_SYNC_REG(i) register
...
/** UART_AT_CMD_CHAR_SYNC_REG(i) register
...
/** UART_TOUT_CONF_SYNC_REG(i) register
...
/** UART_MEM_TX_STATUS_REG(i) register
...
/** UART_MEM_RX_STATUS_REG(i) register
...
/** UART_FSM_STATUS_REG(i) register
...
/** UART_AFIFO_STATUS_REG(i) register
 *  UART AFIFO Status
 */
...
/** UART_REG_UPDATE_REG(i) register
