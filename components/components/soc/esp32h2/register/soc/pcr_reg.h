...
/** PCR_32K_MODEM_SEL : R/W; bitpos: [3:2]; default: 0;
...
/** PCR_ADC_INV_PHASE_CONF_REG register
 *  xxxx
 */
#define PCR_ADC_INV_PHASE_CONF_REG (DR_REG_PCR_BASE + 0x140)
/** PCR_CLK_ADC_INV_PHASE_ENA : R/W; bitpos: [0]; default: 0;
 *  xxxx
 */
#define PCR_CLK_ADC_INV_PHASE_ENA    (BIT(0))
#define PCR_CLK_ADC_INV_PHASE_ENA_M  (PCR_CLK_ADC_INV_PHASE_ENA_V << PCR_CLK_ADC_INV_PHASE_ENA_S)
#define PCR_CLK_ADC_INV_PHASE_ENA_V  0x00000001U
#define PCR_CLK_ADC_INV_PHASE_ENA_S  0

/** PCR_SDM_INV_PHASE_CONF_REG register
 *  xxxx
 */
#define PCR_SDM_INV_PHASE_CONF_REG (DR_REG_PCR_BASE + 0x144)
/** PCR_CLK_SDM_INV_PHASE_ENA : R/W; bitpos: [0]; default: 0;
 *  xxxx
 */
#define PCR_CLK_SDM_INV_PHASE_ENA    (BIT(0))
#define PCR_CLK_SDM_INV_PHASE_ENA_M  (PCR_CLK_SDM_INV_PHASE_ENA_V << PCR_CLK_SDM_INV_PHASE_ENA_S)
#define PCR_CLK_SDM_INV_PHASE_ENA_V  0x00000001U
#define PCR_CLK_SDM_INV_PHASE_ENA_S  0
/** PCR_CLK_SDM_INV_PHASE_SEL : R/W; bitpos: [3:1]; default: 0;
 *  xxxx
 */
#define PCR_CLK_SDM_INV_PHASE_SEL    0x00000007U
#define PCR_CLK_SDM_INV_PHASE_SEL_M  (PCR_CLK_SDM_INV_PHASE_SEL_V << PCR_CLK_SDM_INV_PHASE_SEL_S)
#define PCR_CLK_SDM_INV_PHASE_SEL_V  0x00000007U
#define PCR_CLK_SDM_INV_PHASE_SEL_S  1
...
/** PCR_DATE : R/W; bitpos: [27:0]; default: 35717248;
