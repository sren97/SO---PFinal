...
typedef union {
    struct {
        ...
        /** mem_sram_addr_bitlen : HRO; bitpos: [19:14]; default: 23;
        ...
        /** mem_cache_sram_usr_wcmd : HRO; bitpos: [20]; default: 1;
         *  For SPI0, In the external RAM mode cache write sram for user define command
         *  This field is only for internal debugging purposes. Do not use it in applications.
         */
        uint32_t mem_cache_sram_usr_wcmd:1;
        /** mem_sram_oct : HRO; bitpos: [21]; default: 0;
         *  reserved
         *  This field is only for internal debugging purposes. Do not use it in applications.
         */
        uint32_t mem_sram_oct:1;
        /** mem_sram_wdummy_cyclelen : HRO; bitpos: [27:22]; default: 1;
...
typedef union {
    struct {
        /** mem_sclk_mode : HRO; bitpos: [1:0]; default: 0;
         *  SPI clock mode bits. 0: SPI clock is off when CS inactive 1: SPI clock is delayed
         *  one cycle after CS inactive 2: SPI clock is delayed two cycles after CS inactive 3:
         *  SPI clock is always on.
         *  This field is only for internal debugging purposes. Do not use it in applications.
        ...
        /** mem_sdout_dual : HRO; bitpos: [11]; default: 0;
        ...
        /** mem_saddr_dual : HRO; bitpos: [12]; default: 0;
        ...
        /** mem_sdin_quad : HRO; bitpos: [14]; default: 0;
        ...
        /** mem_sdout_quad : HRO; bitpos: [15]; default: 0;
        ...
        /** mem_saddr_quad : HRO; bitpos: [16]; default: 0;
        ...
        /** mem_sdummy_wout : HRO; bitpos: [23]; default: 0;
...
typedef union {
    struct {
         ...
         *  The raw bit for spi_mem_c_ECC_ERR_INT interrupt. When SPI_FMEM_ECC_ERR_INT_EN is set
         ...
         *  SPI_FMEM_ECC_ERR_INT_EN is cleared and  spi_smem_c_ECC_ERR_INT_EN is set, this bit is
         *  triggered when the error times of SPI0/1 ECC read external RAM are equal or bigger
         *  than spi_mem_c_ECC_ERR_INT_NUM. When SPI_FMEM_ECC_ERR_INT_EN and
         ...
         *  spi_mem_c_ECC_ERR_INT_NUM. When SPI_FMEM_ECC_ERR_INT_EN and  spi_smem_c_ECC_ERR_INT_EN
...
typedef union {
    struct {
        ...
        /** mem_rdn_ena : HRO; bitpos: [30]; default: 0;
...
typedef union {
    struct {
        /** mem_registerrnd_eco_high : RO; bitpos: [31:0]; default: 892;
         *  ECO high register
         *  This field is only for internal debugging purposes. Do not use it in applications.
         */
...
typedef union {
    struct {
        /** mem_registerrnd_eco_low : RO; bitpos: [31:0]; default: 892;
         *  ECO low register
         *  This field is only for internal debugging purposes. Do not use it in applications.
         */
