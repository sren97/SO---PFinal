...
/* MODEM_SYSCON_MODEM_DIS_WIFI6_FORCE : R/W ;bitpos:[9] ;default: 1'b0 ; */
/*description: .*/
#define MODEM_SYSCON_MODEM_DIS_WIFI6_FORCE    (BIT(9))
#define MODEM_SYSCON_MODEM_DIS_WIFI6_FORCE_M  (BIT(9))
#define MODEM_SYSCON_MODEM_DIS_WIFI6_FORCE_V  0x1
#define MODEM_SYSCON_MODEM_DIS_WIFI6_FORCE_S  9
...
/* MODEM_SYSCON_DATE : R/W ;bitpos:[27:0] ;default: 28'h2401180 ; */
/*description: .*/
