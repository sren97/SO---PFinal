...
typedef union {
    struct {
        ...
        uint32_t reserved_4:1;
        /** tx_mono : R/W; bitpos: [5]; default: 0;
         *  Set this bit to enable transmitter in mono mode
         */
        uint32_t tx_mono:1;
        /** tx_chan_equal : R/W; bitpos: [6]; default: 0;
        ...
        /** tx_chan_mod : R/W; bitpos: [26:24]; default: 0;
         *  I2S transmitter channel mode configuration bits.
         */
        uint32_t tx_chan_mod:3;
        /** sig_loopback : R/W; bitpos: [27]; default: 0;
...
typedef union {
    struct {
        /** date : R/W; bitpos: [27:0]; default: 35655792;
