...
typedef struct {
    ...
    uint32_t reserved_0x0058;                               // 0x0058
    volatile usb_dwc_gdfifocfg_reg_t gdfifocfg_reg;         // 0x005c
    uint32_t reserved_0x0060;                               // 0x0060
    uint32_t reserved_0x0064_0x0100[39];                    // 0x0064 to 0x0100
    volatile usb_dwc_hptxfsiz_reg_t hptxfsiz_reg;           // 0x0100
    volatile usb_dwc_dieptxfi_reg_t dieptxf_regs[4];        // 0x0104 to 0x0110 (depends on OTG_NUM_IN_EPS)
    usb_dwc_dieptxfi_reg_t reserved_0x0114_0x013c[11];      // 0x0114 to 0x013c (depends on OTG_NUM_IN_EPS)
    ...
    usb_dwc_host_chan_regs_t host_chans[8];                 // 0x0500 to 0x05fc (depends on OTG_NUM_HOST_CHAN)
    usb_dwc_host_chan_regs_t reserved_0x0600_0x06fc[8];     // 0x0600 to 0x06fc (depends on OTG_NUM_HOST_CHAN)
    uint32_t reserved_0x0700_0x07fc[64];                    // 0x0700 to 0x07fc
    ...
    uint32_t reserved_0x0838;                               // 0x0838
    uint32_t reserved_0x083c;                               // 0x083c
    uint32_t reserved_0x0840;                               // 0x0840
    uint32_t reserved_0x0844_0x087c[15];                    // 0x0844 to 0x087c (depends on OTG_NUM_EPS)
    uint32_t reserved_0x0880;                               // 0x0880
    uint32_t reserved_0x0884_0x08c0[15];                    // 0x0884 to 0x08c0 (depends on OTG_NUM_EPS)
    ...
    usb_dwc_in_ep_regs_t in_eps[6];                         // 0x0920 to 0x09dc (depends on OTG_NUM_EPS)
    usb_dwc_in_ep_regs_t reserved_0x09e0_0x0afc[9];         // 0x09e0 to 0x0afc (depends on OTG_NUM_EPS)
    ...
    usb_dwc_out_ep_regs_t out_eps[6];                       // 0x0b20 to 0x0bdc (depends on OTG_NUM_EPS)
    usb_dwc_out_ep_regs_t reserved_0x0be0_0x0d00[9];        // 0x0be0 to 0x0cfc (depends on OTG_NUM_EPS)
