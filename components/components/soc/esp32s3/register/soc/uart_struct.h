...
typedef union {
    struct {
         ...
         *  Must be a unit32_t not a bitfield as to avoid
         *  a read->write operation during writing. Reading
         *  during writing would impact RX fifo
         */
...
typedef union {
    struct {
        ...
        /** rx_tout_thrhd : R/W; bitpos: [26:17]; default: 10;
        ...
        /** mem_force_pd : R/W; bitpos: [27]; default: 0;
         *  Set this bit to force power down UART memory.
         */
        uint32_t mem_force_pd:1;
        /** mem_force_pu : R/W; bitpos: [28]; default: 0;
...
typedef union {
    struct {
        ...
        /** autobaud_en : R/W; bitpos: [27]; default: 0;
         *  This is the enable bit for detecting baudrate.
         */
        uint32_t autobaud_en:1;
        /** mem_clk_en : R/W; bitpos: [28]; default: 1;
...
typedef union {
    struct {
        /** xoff_threshold : R/W; bitpos: [9:0]; default: 224;
...
typedef union {
    struct {
        /** xon_threshold : R/W; bitpos: [9:0]; default: 0;
...
typedef union {
    struct {
        /** rxfifo_cnt : RO; bitpos: [9:0]; default: 0;
         ...
         */
        uint32_t rxd:1;
        /** txfifo_cnt : RO; bitpos: [25:16]; default: 0;
...
typedef union {
    struct {
        /** apb_rx_raddr : RO; bitpos: [9:0]; default: 512;
        ...
        uint32_t reserved_10:1;
        /** rx_waddr : RO; bitpos: [20:11]; default: 512;
...
typedef union {
    struct {
        /** date : R/W; bitpos: [31:0]; default: 33587824;
...
typedef union {
    struct {
        /** id : R/W; bitpos: [29:0]; default: 1280;
         *  This register is used to configure the uart_id.
         */
        uint32_t id:30;
        /** high_speed : R/W; bitpos: [30]; default: 1;
        ...
        /** reg_update : R/W/SC; bitpos: [31]; default: 0;
